...
@NonNullApi
public class RestaurantsAppProjectDependency extends DelegatingProjectDependency {

    @Inject
    public RestaurantsAppProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
